...
const
  ...
  ptr_any_off = 16#3FFFFFFF; { Could point anywhere }
  ptr_ext_off = 16#3FFFFFFE; {points to global variables only}
  ptr_loc_off = 16#3FFFFFFD; {points to local variables only}
