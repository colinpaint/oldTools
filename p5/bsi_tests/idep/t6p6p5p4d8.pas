{TEST 6.6.5.4-8, CLASS=IMPLEMENTATIONDEPENDENT, NUMBER=11}

{: This program determines the order and number of evaluations
   of the parameters of the procedure pack. }
{V3.1: New test. }

program t6p6p5p4d8(output);
type
...
begin
   ...
   write(' ORDER OF EVALUATION OF PACK(A,I,Z) IS ');
   pack(a[sideeffect('A',1)], sideeffect('I',1),
        z[sideeffect('Z',1)] );
   writeln( st );
   writeln(' IMPLEMENTATION DEPENDENT...6.6.5.4-8')
end.
