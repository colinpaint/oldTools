...
writeln(' ACCURACY OF REAL OPERATIONS IS');
if min=30 then
   writeln(' GREATER THAN 30 DECIMAL PLACES')
else
   writeln(' ABOUT ', min:2, ' DECIMAL PLACES');
writeln(' IMPLEMENTATION DEFINED...6.7.2.2-17')
end.
