{$s}
{TEST 6.4.3.5-6, CLASS=CONFORMANCE}

{: This test checks that non-text local files are
   processed correctly. }
...
var
   ...
   const
      Limit=127;
   type
      Data = record v:integer; w:boolean end;
   var
      f : file of Data;
      a : Data;
      i : 1..Limit;
...
begin
   ...
   Unions;
   if result=pass then
      writeln(' PASS...6.4.3.5-6')
   else
      writeln(' FAIL...6.4.3.5-6')
end.
