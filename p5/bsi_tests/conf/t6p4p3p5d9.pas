{$s}
{TEST 6.4.3.5-9, CLASS=CONFORMANCE}
...
{  This test explores the reading and writing of files of type other
   ...
   pprocedures.  Only local files can be tested; whether external files
...
begin
   ...
   Unions;
   if result=pass then
      writeln(' PASS...6.4.3.5-9')
   else
      writeln(' FAIL...6.4.3.5-9')
end.
