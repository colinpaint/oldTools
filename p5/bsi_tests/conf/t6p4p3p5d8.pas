{$s}
{TEST 6.4.3.5-8, CLASS=CONFORMANCE}
...
{  This test explores the reading and writing of files of type other
   ...
   packed unstructured types. }
{V3.1: New test. }

program t6p4p3p5d8(output);
var
   ix,iy,iz : integer;
   result : (pass,fail);
...
begin
   ...
   SubrangeOfInteger;
   if result=pass then
      writeln(' PASS...6.4.3.5-8')
   else
      writeln(' FAIL...6.4.3.5-8')
end.
